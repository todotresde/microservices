...
class BookGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("app2app:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
