package com.todotresde.myapp.gateway.security.oauth2;

import com.todotresde.myapp.gateway.config.oauth2.OAuth2Properties;
import com.todotresde.myapp.gateway.web.filter.RefreshTokenFilter;
...
public class OAuth2AuthenticationServiceTest {
    ...
    private void mockRefreshGrant() {
        ...
        when(restTemplate.postForEntity("http://localhost:9999/oauth/token", entity, OAuth2AccessToken.class))
